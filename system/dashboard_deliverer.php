...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
        ...
        <a href="<?= SYS_URL ?>/delivery/manage.php" class="small-box-footer">
            <div class="small-box bg-danger">
                <div class="inner">
                    <h3 id="NumberOfExpired"> 
                        <?php
                        $db = dbConn();
                        $sql = "SELECT COUNT(*) AS NOOFORDERS FROM orders o INNER JOIN order_status os ON o.StatusId=os.Id WHERE os.StatusName='Invoiced' AND o.DeliveryMethod = 'Delivery'";
                        $result = $db->query($sql);
