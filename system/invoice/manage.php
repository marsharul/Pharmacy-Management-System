...
//                Display 
                $db= dbConn();
                $sql= "SELECT o.*,os.StatusName,c.*,u.* FROM orders o INNER JOIN order_status os ON o.StatusId=os.Id INNER JOIN customers c ON c.CustomerId= o.CustomerId LEFT JOIN users u ON u.UserId=c.UserId WHERE os.StatusName='Issued' || os.StatusName='Invoiced'";
                $result=$db->query($sql);
