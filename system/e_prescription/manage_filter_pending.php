...
<div class="row">
    <div class="col-12">
        <a href="../dashboard.php" class="btn btn-dark mb-2"> <i class="fas fa-plus-circle"></i> Back</a>
        <div class="card">
            ...
            <div class="card-body table-responsive p-0 bgcolorbody">
                <?php
                $db = dbConn();
                $sql = "SELECT p.*,ps.StatusName FROM prescriptions p INNER JOIN prescription_status ps ON ps.Id=p.StatusId WHERE ps.StatusName ='Pending'";
                $result = $db->query($sql);
                ?>
