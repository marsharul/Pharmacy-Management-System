...
<html>
    ...
    <body>
        ...
        $sql = "SELECT s.Id AS StockId,i.ItemName,(s.Qty-s.IssuedQty) AS current_available_qty,s.RetailPrice,s.CostPrice,s.ExpiryDate,l.LocationName,l.Area,d.DistributorName FROM stocks s LEFT JOIN distributor d ON s.DistributorId=d.Id LEFT JOIN locations l ON l.Id=s.LocationId LEFT JOIN items i ON i.Id=s.ItemId WHERE ExpiryDate <= CURDATE()";
        $result = $db->query($sql);
        ?>
