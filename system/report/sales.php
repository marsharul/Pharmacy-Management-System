...
<?php
$db = dbConn();
$sql = "SELECT DATE_FORMAT(o.OrderDate, '%M') as month, SUM(i.RetailPrice * i.Qty) as amt FROM `order_items` i INNER JOIN orders o ON o.Id = i.OrderId GROUP BY month ORDER BY MONTH(o.OrderDate)";
$result = $db->query($sql);
